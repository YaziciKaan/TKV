...
if __name__ == "__main__":
    ...
    model.predict(source=sources, weights='runs\\train-seg\\train\\weights\\best.pt', hide_conf=True, hide_labels=True, iou_thres=0.75, conf_thres=0.75, save_txt=True, exist_ok=True, project="detections", name="kidney", imgsz=(512,512))